# -*- coding: utf-8 -*-
"""
Created on Sun Nov 22 15:17:20 2020
...
# pathIn = 'D:\QQ\MobileFile\test.mp4'
    ...
    ##提取特定时间点图片
        ...
        while success and count < len(extract_time_points):
            ...
            if success:
                ...
                print("{}_{}.jpg".format(output_prefix, str(count+1)))
                cv2.imwrite(os.path.join(pathOut, "{}_{}.jpg".format(output_prefix, str(count+1))), image, [int(cv2.IMWRITE_JPEG_QUALITY), jpg_quality])     # save frame as JPEG file
                count = count + 1
...
if __name__ == "__main__":
    for file in os.listdir("./static/images/mp4"):
        if file.endswith(".mp4"):
            pathIn = os.path.join('./static/images/mp4', file)

    #pathIn = 'D:\QQ\MobileFile\\test-2.mp4'
    # pathIn = 'C:/Users/Administrator/www/video_back/video_back/upload/1.mp4'
    pathOut = './static/images/pic'
    # pathOut = 'C:/Users/Administrator/www/video_back/video_back/upload/'
    imgname = 'dog'
    video2frames(pathIn,pathOut,imgname,extract_time_points=(3,3.5))
