...
def main(): 
    ...
    for file in os.listdir("./static/images/regain"):
        im_file = os.path.join('/static/images/regain', file)
        inpaintMask = cv.imread(im_file, 0)
    for file in os.listdir("./static/images/regain"):
        im_file = os.path.join('/static/images/regain', file)
    ...
    # Acts as a mask
    #inpaintMask = cv.imread("./data/demo/3.jpg",0)
    ...
    while True:
        ...
        if ch == ord('t'):
            ...
            cv.imwrite(r'./static/images/regain/FMM.jpg', res)
        ...
        if ch == ord('n'):
            ...
            cv.imwrite(r'./static/images/regain/NS_Technique.jpg', res)
